-- ============================================================
-- Migration: 004_periodic_performance_v2
-- Description: Update get_periodic_performance to accept UUID[]
-- for account type filtering (multiple accounts at once)
-- Replaces p_account_id UUID with p_account_ids UUID[]
-- ============================================================
